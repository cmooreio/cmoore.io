...
const nodes = ref([
  ...
  // Edge Layer
  {
    ...
    data: { label: 'Cloudflare Tunnel', subtitle: 'Outbound only', icon: '🛡️', category: 'edge' }
  },
  {
    id: 'traefik',
    type: 'custom',
  ...
  // Control Plane
  {
    ...
    data: { label: 'rpi1', subtitle: 'control-plane + Omada', icon: '🎛️', category: 'control' }
  },
  {
    id: 'rpi2',
    type: 'custom',
  ...
  },
  {
    ...
    data: { label: 'rpi3', subtitle: 'control-plane + Semaphore', icon: '🎛️', category: 'control' }
  },
  // Workers
  {
    id: 'rpi5',
  ...
  },
  {
    ...
    data: { label: 'rpi7', subtitle: 'UniFi', icon: '🖥️', category: 'worker' }
  },
  {
    id: 'rpi8',
    type: 'custom',
  ...
  // AI Nodes
  {
    ...
    data: { label: 'aimax', subtitle: 'ROCm (worker)', icon: '🔴', category: 'ai' }
  },
  {
    id: 'thor',
    type: 'custom',
...
const edges = ref([
  ...
  { id: 'e-storage-aimax', source: 'longhorn', target: 'aimax', sourceHandle: 'top', targetHandle: 'target-bottom', animated: true, style: { stroke: '#f59e0b', strokeDasharray: '5,5' } },
