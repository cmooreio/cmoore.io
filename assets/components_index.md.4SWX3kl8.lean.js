import{v as c,o as p,c as g,ag as m}from"./chunks/framework.D2Tqfz8O.js";const b=JSON.parse('{"title":"Software Overview","description":"","frontmatter":{"prev":{"text":"Architecture","link":"/architecture/"},"next":{"text":"Infrastructure","link":"/components/infrastructure"}},"headers":[],"relativePath":"components/index.md","filePath":"components/index.md"}'),u={name:"components/index.md"},v=Object.assign(u,{setup(h){return c(()=>{const e="kubectl get nodes",t=`NAME    STATUS   ROLES                  VERSION
