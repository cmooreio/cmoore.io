import{v as f,c as _,o as S,ae as b}from"./chunks/framework.ulrP7gqJ.js";const k="/raspberry-pi-5.jpg",R="/nvidia-jetson-agx-thor.jpg",w="/ansible-argocd.jpg",T="/kubernetes.jpg",x="/prometheus-grafana.jpg",A="/home-assistant-philips-hue.jpg",q=JSON.parse('{"title":"","description":"","frontmatter":{"layout":"home","hero":{"name":"cmoore.io","tagline":"k3s Raspberry Pi 5 cluster with GitOps, AI inference, and home automation"}},"headers":[],"relativePath":"index.md","filePath":"index.md"}'),C={name:"index.md"},I=Object.assign(C,{setup(P){return f(()=>{const r="kubectl get nodes",a=`NAME    STATUS   ROLES                  VERSION
