...
thor    Ready    cuda-inference         v1.35.0+k3s3`,i=document.querySelector(".typed-text"),l=document.querySelector(".cursor"),s=document.querySelector(".terminal-output");if(i&&l&&s){let t=0;const n=()=>{t<e.length?(i.textContent+=e[t],t++,setTimeout(n,80+Math.random()*40)):(l.style.display="none",setTimeout(()=>{let d=0;const r=a.split(`
