...
thor    Ready    <none>                 v1.36.0+k3s1`,a=document.querySelector(".typed-text"),o=document.querySelector(".cursor"),s=document.querySelector(".terminal-output");if(a&&o&&s){let r=0;const i=()=>{r<e.length?(a.textContent+=e[r],r++,setTimeout(i,80+Math.random()*40)):(o.style.display="none",setTimeout(()=>{let n=0;const d=t.split(`
